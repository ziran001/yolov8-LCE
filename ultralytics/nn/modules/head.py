...
class GhostDetect(Detect):
    """Detection head that leverages Ghost convolutions for cheaper feature extraction."""

    def __init__(self, nc: int = 80, ch: tuple = ()):
        """Initialize GhostDetect with GhostConv-based feature towers."""
